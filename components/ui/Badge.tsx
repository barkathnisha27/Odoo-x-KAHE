...
export function Badge({ children, variant = 'default', size = 'sm', className }: BadgeProps) {
  const variants = {
    default: 'bg-[rgba(255,255,255,0.08)] text-[var(--text-secondary)] border-[rgba(255,255,255,0.1)]',
    accent: 'bg-[rgba(0,212,255,0.15)] text-[#00D4FF] border-[rgba(0,212,255,0.3)]',
    warm: 'bg-[rgba(255,123,53,0.15)] text-[#FF7B35] border-[rgba(255,123,53,0.3)]',
